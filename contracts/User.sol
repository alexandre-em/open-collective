...
contract Users {
  struct User {
    ...
    string username;
    uint256 userBalance;
    uint256 nbDepositTransactions;
    uint256 nbWithdrawTransactions;
    bool registered;
  }
  ...
  function openAccount(string memory _username) public payable returns (User memory) {
    require(
  ...
  function withdrawUserBalance(uint256 amount) external {
    ...
    require(
      ...
      "Account balance is downer than your withdraw amount"
    );
